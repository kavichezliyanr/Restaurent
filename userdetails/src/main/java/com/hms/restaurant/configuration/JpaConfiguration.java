 ...
 * 
 */
package com.hms.restaurant.configuration;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages="com.hms.restaurant.repository" ,
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.hms.restaurant.data" });
